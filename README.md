...
```sh
git clone https://github.com/rmndkyl/swisstronik-proxy.git
cd swisstronik-proxy
```
...
Enjoy working with Swisstronik and be sure to subscribe to [Layer Airdrop](https://t.me/layerairdrop)!
